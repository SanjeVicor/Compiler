...
instructionRegexList.append({'expression' : r"else\s+if\x28\s*((\d+|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)\s*(<|>|<=|>=|!=|==)\s*(\d+|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)|(\d+(\x2e)\d{1,7}|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)\s*(<|>|<=|>=|!=|==)\s*(\d+(\x2e)\d{1,7}|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)|(\d+(\x2e)\d{1,16}|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)\s*(<|>|<=|>=|!=|==)\s*(\d+(\x2e)\d{1,16}|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)|((\x22.\x22)|(\x27.\x27)|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)\s*(!=|==)\s((\x22.\x22)|(\x27.\x27)|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)|((\x22*\x22)|(\x27.*\x27)|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*)\s*(!=|==)\s*((\x22.*\x22)|(\x27.*\x27)|(\x5f|\x24|\x2a)*[a-zA-Z](\w|\d)*))\s*\x29(\s*({?)\s*(}?))?", 'type' : 'else if'})
