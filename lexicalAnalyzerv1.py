...
compilersWords[r'(int|float|double|void|char|string|bool)\s+'] = {'message':'Tipo de dato'}
...
compilersWords[r'\x24'] = {'message':'operador para instrucciones ASM'}
compilersWords[r'\x23'] = {'message':'operador para iincluir librerias o definir constantes'}
